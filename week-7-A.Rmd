...
```{r}
q_resamples %>%
  ggplot(aes(mean_hours, y = after_stat(count/sum(count)))) +
  geom_histogram(bins = 70, fill = "violet", colour = "white") +
 geom_vline(linetype = "dashed", colour = "blue", xintercept = mean(qscores$hours)) 
```
